  ...
  let directors = []; 
    ...
    result = <div className="current-movie">
      ...
      <div className="kinopoisk-rating-movie">
          <span className="kinopoisk-movie">
            КП
          </span><br/>
          <span className="rating-movie">
      ...
      <img 
          src={movie.logo.url} 
          alt="alt"
          className="logo-movie-page">
      </img>
      <img 
          src={movie.poster.url} 
          alt="alt" 
          className="image-movie-page">
      </img>
      <div className="info-movie-page"> 
          ...
          <div className="movie-director"> 
             режиссер: {directors.slice(0,6).join(', ')}
          </div>
          <div className="movie-actor">
             в ролях: {actors.slice(0,6).join(', ')}
          </div>
